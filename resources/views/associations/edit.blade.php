                ...
                <form method="POST" action="{{ route('associations.update', $association) }}"
                    ...
                    <div class="fm-section">
                        <div class="fm-section-head">
                            <div class="fm-section-icon"><i class="bi bi-building-gear"></i></div>
                        ...
                        <div class="fm-section-body">
                            <div class="fm-group">
                                ...
                                <input type="text" name="name"
                                       class="fm-input @error('name') fm-input-error @enderror"
                            ...
                            {{-- Photo / Logo --}}
                            <div class="fm-group">
                                <label class="fm-label"><i class="bi bi-image me-1"></i> Photo / Logo</label>
                                @if($association->logo)
                                    <div class="fm-current-file mb-2">
                                        <img src="{{ Storage::url($association->logo) }}"
                                             alt="Logo actuel"
                                             style="height:60px;border-radius:var(--radius-md);object-fit:cover;">
                                        <span class="ms-2 text-muted" style="font-size:0.78rem;">Logo actuel</span>
                                    </div>
                                @endif
                                <div class="fm-file-zone @error('logo') fm-file-zone-error @enderror" id="logoZone">
                                    ...
                                    <div class="fm-file-content" id="logoContent">
                                        ...
                                        <span class="fm-file-text">Cliquez pour changer le logo</span>
                            ...
                            <div class="fm-row">
                                <div class="fm-group">
                                    ...
                                    <input type="text" name="phone_mobile"
                                           ...
                                           value="{{ old('phone_mobile', $association->phone_mobile) }}"
                                ...
                                <div class="fm-group">
                                    ...
                                    <input type="text" name="phone_fix"
                                           ...
                                           value="{{ old('phone_fix', $association->phone_fix) }}"
                    ...
                    <div class="fm-section">
                        <div class="fm-section-head">
                            ...
                            <span class="fm-section-title">
                                ...
                                <span class="fm-section-optional">laisser vide pour conserver les actuels</span>
                            </span>
                        </div>
                        <div class="fm-section-body">
                            ...
                            <div class="fm-group">
                                ...
                                @if($association->doc_rne)
                                    <div class="fm-current-file mb-2">
                                        ...
                                        <a href="{{ Storage::url($association->doc_rne) }}" target="_blank"
                                           class="ms-1" style="font-size:0.78rem;">Voir le document actuel</a>
                                    </div>
                                @endif
                                <div class="fm-file-zone @error('doc_rne') fm-file-zone-error @enderror" id="rneZone">
                                    <input type="file" name="doc_rne" id="doc_rne"
                                           ...
                                           class="fm-file-input"
                                           onchange="updateDocName(this, 'rnePreview', 'rneZone')">
                                    <div class="fm-file-content">
                                        <i class="bi bi-file-earmark-arrow-up" style="font-size:1.5rem;color:var(--cl-muted);"></i>
                                        <span class="fm-file-text">Cliquez pour remplacer le RNE</span>
                            ...
                            <div class="fm-group">
                                ...
                                @if($association->doc_fiscal)
                                    <div class="fm-current-file mb-2">
                                        <i class="bi bi-file-earmark-check text-success"></i>
                                        <a href="{{ Storage::url($association->doc_fiscal) }}" target="_blank"
                                           class="ms-1" style="font-size:0.78rem;">Voir le document actuel</a>
                                    </div>
                                @endif
                                <div class="fm-file-zone @error('doc_fiscal') fm-file-zone-error @enderror" id="fiscalZone">
                                    <input type="file" name="doc_fiscal" id="doc_fiscal"
                                           accept=".jpg,.jpeg,.png,.pdf"
                                           class="fm-file-input"
                                           onchange="updateDocName(this, 'fiscalPreview', 'fiscalZone')">
                                    <div class="fm-file-content">
                                        <i class="bi bi-file-earmark-arrow-up" style="font-size:1.5rem;color:var(--cl-muted);"></i>
                                        <span class="fm-file-text">Cliquez pour remplacer la carte fiscale</span>
                                        <span class="fm-file-hint">JPG, PNG, PDF — max 5 Mo</span>
                                    </div>
                                </div>
                    ...
                    <div class="fm-actions fm-actions--split">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('associations.show', $association) }}" class="fm-btn fm-btn--ghost">Annuler</a>
...
<style>
    ...
    .fm-section-optional { font-weight: 400; font-size: 0.72rem; color: var(--cl-muted-light); margin-left: 0.4rem; }
    ...
    .fm-current-file { display: flex; align-items: center; padding: 0.4rem 0.75rem; background: var(--cl-green-soft); border: 1px solid rgba(45,198,83,0.2); border-radius: var(--radius-sm); font-size: 0.78rem; color: #1A8C38; }
    ...
    .fm-file-content { display: flex; flex-direction: column; align-items: center; padding: 1rem; gap: 0.3rem; pointer-events: none; }
    ...
    .fm-btn--danger-outline { background: var(--cl-red-glow); color: var(--cl-red); border: 1.5px solid rgba(230,57,70,0.2) !important; }
    .fm-btn--danger-outline:hover { background: var(--cl-red); color: #fff; transform: translateY(-1px); }
